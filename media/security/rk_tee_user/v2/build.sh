...
# Check for buildroot internal toolchain first
BUILDROOT_TOOLCHAIN=$WORK_DIR_TOP/../../../../sysdrv/source/buildroot/buildroot-2024.11.4/output/host
if [ -d "$BUILDROOT_TOOLCHAIN/bin" ]; then
